...
This tutorial assumes you have access to the [Rackspace Public Cloud](https://www.rackspace.com/openstack/public). For basic infrastructure requirements the lessons learned in this tutorial can be applied to other platforms.
